...
application.use("/pairs", pairRouter); // http://localhost:8081/pairs/.....
application.use("/currencies", currencyRouter); // http://localhost:8081/currencies/.....
application.use("/users", userRouter); // http://localhost:8081/users/.....
